...
* **Benchmark Performance:** Provide an isolated sandbox environment to test, review, and baseline the performance capabilities of Oracle workloads running on Google Cloud Compute Engine and SSD Persistent Disks and Database running on Oracle Exascale@GCP.
...
```bash
# Deploy changes
make exascale_deploy_peoplesoft
```
...
Open a browser and login to http://apps.example.com:8001/ps/signon.html
