# Oracle JD Edwards EnterpriseOne Customer Environment

This folder provides Terraform infrastructure-as-code automation to deploy Oracle JD Edwards EnterpriseOne the full set of infrastructure running on Google Cloud Platform.
...
![Oracle JD Edwards Customer Data Technical Architecture Diagram](images/JD_ENT_ONE_CUST_DATA_GCP_tech_arch.png "Oracle JD Edwards Customer Data on GCP Technical Architecture Diagram")
...
## Oracle JD Edwards EnterpriseOne Customer environment Deployment
...
Run the commands below to deploy the Oracle JD Edwards environment that consists of 5 servers:
...
# Plan the changes
make jde_cust_data_plan

# Deploy the changes
make jde_cust_data_deploy
```
...
127.0.0.1 jde-db.c.$PROJECT_ID$ jde-db
